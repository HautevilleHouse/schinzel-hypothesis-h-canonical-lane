# Constant Extraction Spec (SHH)
    ...
    ## Formula Set
    - `kappa_pattern_raw = c_pattern_raw * pattern_density_raw - e_pattern_raw`
- `sigma_local_raw = local_floor_raw - congruence_loss_raw - restart_loss_raw`
- `kappa_compact_raw = 1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity_raw = rho_rigidity_raw`
- `pattern_transfer_raw = c_pattern_bridge_raw * transfer_gain_raw - e_pattern_bridge_raw`
- `eps_coh_raw = eps_coh_raw`
- `sigma_star_can_raw = sigma_star_can_raw`

    ## Validations
    - positivity required for: `kappa_pattern`, `sigma_local`, `kappa_compact`, `rho_rigidity`, `pattern_transfer`, `sigma_star_can`
    ...
    3. `scripts/shh_closure_guard.py`
