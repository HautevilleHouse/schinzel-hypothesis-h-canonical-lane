...
mkdir -p .codex_tmp/schinzel_hypothesis_h
cp artifacts/stitch_constants.json .codex_tmp/schinzel_hypothesis_h/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/schinzel_hypothesis_h/constants_registry.json
